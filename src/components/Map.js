    ...
    <Container className="embed-responsive">
      <Grid container>
        <LeftGrid item xs={12} md={6}>
          <CenteredWrapper>
            <Typography variant="h4" align="center">Zapraszamy do kontaktu</Typography>
            <ContactBox>
              ...
              <div>
                ...
                <Typography variant="h6"><b>+(48) 607 514 585</b></Typography>
              </div>
            </ContactBox>
            <ContactBox>
              <IconButton style={{ margin: "0.5rem" }}>
              ...
              <div>
                ...
                <Typography variant="body1"><b>kinga.bieda.kb@gmail.com</b></Typography>
              </div>
            </ContactBox>
          </CenteredWrapper>
        </LeftGrid>
